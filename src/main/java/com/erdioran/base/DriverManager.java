    ...
    public static void launchBrowser(String browser) {
        ...
        if (browser.equalsIgnoreCase("chrome")) {
            ...
            if (ConfigManager.getBooleanValue("auto.resolve.firefox.browser.path", true)) {
                ...
                assertTrue("Please set absolute path to firefox.exe in src/test/resources/app.properties",
                        StringUtils.isNotBlank(ConfigManager.getConfigProperty("firefox.browser.path")));
